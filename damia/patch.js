...
const N_n_3_15_state = {
                                value: 0,
                            }
const N_n_3_14_state = {
                                value: 0,
                            }
...
const N_n_3_33_state = {
                                msgSpecs: [],
                            }
const N_n_3_34_state = {
                                msgSpecs: [],
                            }
...
const N_n_5_66_state = {
                                msgSpecs: [],
                            }
const N_n_5_33_state = {
                                minValue: 0,
maxValue: 100,
                            }
...
const N_n_5_67_state = {
                                msgSpecs: [],
                            }
const N_n_5_40_state = {
                                threshold: 1,
                            }
const N_n_5_41_state = {
                                msgSpecs: [],
                            }
const N_n_5_44_state = {
                                value: 0,
                            }
const N_m_n_5_34_1_sig_state = {
                                currentValue: 0,
                            }
const N_m_n_5_52_1_sig_state = {
                                currentValue: 0,
                            }
const N_m_n_5_56_1_sig_state = {
                                currentValue: 0,
                            }
const N_m_n_5_60_1_sig_state = {
                                currentValue: 0,
                            }
const N_n_5_68_state = {
                                msgSpecs: [],
                            }
...
const N_n_5_46_state = {
                                leftOp: 0,
rightOp: 0,
                            }
const N_n_5_47_state = {
                                floatValues: [0,50],
stringValues: ["",""],
                            }
...
const N_m_n_0_33_1_sig_state = {
                                currentValue: 0.125,
                            }
const N_m_n_6_14_0_sig_state = {
                                currentValue: 43.5337,
                            }
const N_n_6_14_state = {
                                delayName: "",
...
const N_m_n_6_24_0_sig_state = {
                                currentValue: 7.645,
                            }
const N_n_6_24_state = {
                                delayName: "",
buffer: G_delayBuffers_NULL_BUFFER,
rawOffset: 0,
offset: 0,
...
const N_n_5_34_state = {
                                previous: 0,
coeff: 0,
                            }
const N_m_n_6_22_0_sig_state = {
                                currentValue: 4.2546,
                            }
...
const N_n_5_56_state = {
                                previous: 0,
coeff: 0,
                            }
const N_m_n_5_19_0_sig_state = {
...
function N_n_0_34_rcvs_0(m) {
            ...
            if (G_msg_getLength(m) === 1) {
                if (
                    ...
                    N_n_0_34_state.realNextTick = toFloat(FRAME)
                    NT_metro_scheduleNextTick(N_n_0_34_state)
                    return
                }
            }
...
function N_n_0_34_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        NT_metro_setRate(N_n_0_34_state, G_msg_readFloatToken(m, 0))
        return
    }
...
function N_n_0_23_rcvs_0(m) {
            ...
            G_msgBuses_publish(N_n_0_23_state.busName, m)
            return
...
function N_n_4_14_rcvs_0(m) {
                    ...
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_4_14_state, G_msg_readFloatToken(m, 0))
                        N_n_4_3_rcvs_0(G_msg_floats([N_n_4_14_state.leftOp + N_n_4_14_state.rightOp]))
                        return
...
function N_n_4_12_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_4_12_state.msgSpecs.splice(0, N_n_4_12_state.msgSpecs.length - 1)
                    N_n_4_12_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_4_12_state.msgSpecs[0].outMessage
                        },
                    ...
                    for (let i = 0; i < N_n_4_12_state.msgSpecs.length; i++) {
                        if (N_n_4_12_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_4_12_state.msgSpecs[i].send, N_n_4_12_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_4_8_rcvs_0(N_n_4_12_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_4_8_rcvs_0(m) {
            ...
            N_n_4_17_rcvs_0(G_bangUtils_bang())
N_n_4_16_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
            return
...
function N_n_4_16_rcvs_0(m) {
            ...
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_4_16_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_4_16_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_4_16_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_4_16_state.floatValues[1])
...
function N_n_4_17_rcvs_0(m) {
            ...
            if (G_msg_getLength(m) === 1) {
                if (G_msg_isStringToken(m, 0)) {
                    ...
                    if (action === 'bang' || action === 'start') {
                        NT_delay_scheduleDelay(
                            N_n_4_17_state, 
                            () => N_n_4_18_rcvs_0(G_bangUtils_bang()),
                            FRAME,
                        )
                        return
                    } else if (action === 'stop') {
                        NT_delay_stop(N_n_4_17_state)
                        return
                    }
                    
                } else if (G_msg_isFloatToken(m, 0)) {
                    NT_delay_setDelay(N_n_4_17_state, G_msg_readFloatToken(m, 0))
                    NT_delay_scheduleDelay(
                        N_n_4_17_state,
                        () => N_n_4_18_rcvs_0(G_bangUtils_bang()),
                        FRAME,
                ...
                N_n_4_17_state.sampleRatio = computeUnitInSamples(
                    SAMPLE_RATE, 
...
function N_n_4_18_rcvs_0(m) {
            ...
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_4_18_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_4_18_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_4_18_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_4_18_state.floatValues[1])
...
function N_n_7_12_rcvs_0(m) {
                            
            N_n_7_13_rcvs_0(G_bangUtils_bang())
N_n_7_14_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
N_n_7_0_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
            return
        
                            throw new Error('Node "n_7_12", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_7_0_rcvs_0(m) {
                    ...
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        const value = G_msg_readFloatToken(m, 0)
                        N_m_n_7_1_0__routemsg_rcvs_0(G_msg_floats([G_funcs_mtof(value)]))
                        return
                    }
...
function N_m_n_7_1_0__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_7_1_0_sig_rcvs_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_7_1_0__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_7_1_0_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_7_1_0_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_7_1_0_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_7_14_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_7_14_state, G_msg_readFloatToken(m, 0))
                        N_n_7_3_rcvs_0(G_msg_floats([N_n_7_14_state.leftOp + N_n_7_14_state.rightOp]))
                        return
...
function N_n_7_3_rcvs_0(m) {
                    ...
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        const value = G_msg_readFloatToken(m, 0)
                        N_m_n_7_2_0__routemsg_rcvs_0(G_msg_floats([G_funcs_mtof(value)]))
                        return
                    }
...
function N_m_n_7_2_0__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_7_2_0__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_7_2_0__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_7_2_0_sig_outs_0 = 0
function N_m_n_7_2_0_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_7_2_0_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_7_2_0_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_7_13_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_7_13_state.msgSpecs.splice(0, N_n_7_13_state.msgSpecs.length - 1)
                    N_n_7_13_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_7_13_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_7_13_state.msgSpecs.length; i++) {
                        if (N_n_7_13_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_7_13_state.msgSpecs[i].send, N_n_7_13_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_7_8_rcvs_0(N_n_7_13_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_7_13", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_7_8_rcvs_0(m) {
                            
            N_n_7_17_rcvs_0(G_bangUtils_bang())
N_n_7_16_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
            return
        
                            throw new Error('Node "n_7_8", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_7_16_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_7_16_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_7_16_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_7_16_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_7_16_state.floatValues[1])
    
            N_n_7_5_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_7_16", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
            ...
            if (G_msg_getLength(m) === 1) {
                if (G_msg_isStringToken(m, 0)) {
                    ...
                    if (action === 'bang' || action === 'start') {
                        NT_delay_scheduleDelay(
                            N_n_7_17_state, 
                            () => N_n_7_18_rcvs_0(G_bangUtils_bang()),
                            FRAME,
                        )
                        return
                    } else if (action === 'stop') {
                        NT_delay_stop(N_n_7_17_state)
                        return
                    }
                    
                } else if (G_msg_isFloatToken(m, 0)) {
                    NT_delay_setDelay(N_n_7_17_state, G_msg_readFloatToken(m, 0))
                    NT_delay_scheduleDelay(
                        N_n_7_17_state,
                        () => N_n_7_18_rcvs_0(G_bangUtils_bang()),
                        FRAME,
                ...
                N_n_7_17_state.sampleRatio = computeUnitInSamples(
                    SAMPLE_RATE, 
                    G_msg_readFloatToken(m, 1), 
                    G_msg_readStringToken(m, 2)
                )
                return
                            ...
                            throw new Error('Node "n_7_17", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_7_18_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_7_18_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_7_18_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_7_18_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_7_18_state.floatValues[1])
    
            N_n_7_5_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_7_18", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_8_12_rcvs_0(m) {
                            
            N_n_8_15_rcvs_0(G_bangUtils_bang())
N_n_8_13_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
N_n_8_0_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
            return
        
                            throw new Error('Node "n_8_12", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_0_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        const value = G_msg_readFloatToken(m, 0)
                        N_m_n_8_1_0__routemsg_rcvs_0(G_msg_floats([G_funcs_mtof(value)]))
                        return
                    }
                
                            throw new Error('Node "n_8_0", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_8_1_0__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_8_1_0_sig_rcvs_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_8_1_0__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_8_1_0_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_8_1_0_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_8_1_0_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_13_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_8_13_state, G_msg_readFloatToken(m, 0))
                        N_n_8_3_rcvs_0(G_msg_floats([N_n_8_13_state.leftOp + N_n_8_13_state.rightOp]))
                        return
                        ...
                        return
                            ...
                            throw new Error('Node "n_8_13", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_3_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        const value = G_msg_readFloatToken(m, 0)
                        N_m_n_8_2_0__routemsg_rcvs_0(G_msg_floats([G_funcs_mtof(value)]))
                        return
                    }
                
                            throw new Error('Node "n_8_3", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_8_2_0__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_8_2_0__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_8_2_0__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_8_2_0_sig_outs_0 = 0
function N_m_n_8_2_0_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_8_2_0_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_8_2_0_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_15_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_8_15_state.msgSpecs.splice(0, N_n_8_15_state.msgSpecs.length - 1)
                    N_n_8_15_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_8_15_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_8_15_state.msgSpecs.length; i++) {
                        if (N_n_8_15_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_8_15_state.msgSpecs[i].send, N_n_8_15_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_8_8_rcvs_0(N_n_8_15_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_8_15", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_8_rcvs_0(m) {
                            
            N_n_8_17_rcvs_0(G_bangUtils_bang())
N_n_8_16_rcvs_0(G_msg_floats([G_tokenConversion_toFloat(m, 0)]))
            return
        
                            throw new Error('Node "n_8_8", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_16_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_8_16_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_8_16_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_8_16_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_8_16_state.floatValues[1])
    
            N_n_8_5_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_8_16", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_8_5_rcvs_0(m) {
            ...
            if (
                ...
                switch (G_msg_getLength(m)) {
                    case 2:
                        NT_line_t_setNextDuration(N_n_8_5_state, G_msg_readFloatToken(m, 1))
                    case 1:
                        NT_line_t_setNewLine(N_n_8_5_state, G_msg_readFloatToken(m, 0))
                }
                return
    
            } else if (G_actionUtils_isAction(m, 'stop')) {
                NT_line_t_stop(N_n_8_5_state)
                return
            ...
            if (G_msg_getLength(m) === 1) {
                if (G_msg_isStringToken(m, 0)) {
                    ...
                    if (action === 'bang' || action === 'start') {
                        NT_delay_scheduleDelay(
                            N_n_8_17_state, 
                            () => N_n_8_18_rcvs_0(G_bangUtils_bang()),
                            FRAME,
                        )
                        return
                    } else if (action === 'stop') {
                        NT_delay_stop(N_n_8_17_state)
                        return
                    }
                    
                } else if (G_msg_isFloatToken(m, 0)) {
                    NT_delay_setDelay(N_n_8_17_state, G_msg_readFloatToken(m, 0))
                    NT_delay_scheduleDelay(
                        N_n_8_17_state,
                        () => N_n_8_18_rcvs_0(G_bangUtils_bang()),
                        FRAME,
                ...
                N_n_8_17_state.sampleRatio = computeUnitInSamples(
                    SAMPLE_RATE, 
                    G_msg_readFloatToken(m, 1), 
                    G_msg_readStringToken(m, 2)
                )
                return
                            ...
                            throw new Error('Node "n_8_17", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_8_18_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_8_18_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_8_18_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_8_18_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_8_18_state.floatValues[1])
    
            N_n_8_5_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_8_18", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_0_26_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_0_26_state, G_msg_readFloatToken(m, 0))
                N_n_0_34_rcvs_1(G_msg_floats([N_n_0_26_state.value]))
                return 
...
function N_n_0_35_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_0_35_state.msgSpecs.splice(0, N_n_0_35_state.msgSpecs.length - 1)
                    N_n_0_35_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_0_35_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_0_35_state.msgSpecs.length; i++) {
                        if (N_n_0_35_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_0_35_state.msgSpecs[i].send, N_n_0_35_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_0_35_snds_0(N_n_0_35_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
                ...
                if (
                    ...
                    for (let i = 0; i < N_n_0_36_state.msgSpecs.length; i++) {
                        if (N_n_0_36_state.msgSpecs[i].hasSend) {
                            ...
                            N_n_0_36_snds_0(N_n_0_36_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
                ...
                if (
                    ...
                    for (let i = 0; i < N_n_0_37_state.msgSpecs.length; i++) {
                        if (N_n_0_37_state.msgSpecs[i].hasSend) {
                            ...
                            N_n_0_37_snds_0(N_n_0_37_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_ioSnd_n_0_37_0_rcvs_0(m) {
                            
                IO_snd_n_0_37_0(m)
                return
            
                            throw new Error('Node "n_ioSnd_n_0_37_0", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_0_38_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_0_38_state, G_msg_readFloatToken(m, 0))
                N_n_0_38_snds_0(G_msg_floats([N_n_0_38_state.value]))
                return 
...
function N_n_0_38_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_0_38", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_42_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_3_42_state, G_msg_readFloatToken(m, 0))
                        N_n_0_11_rcvs_0(G_msg_floats([N_n_3_42_state.leftOp + N_n_3_42_state.rightOp]))
                        return
                        ...
                        return
                            ...
                            throw new Error('Node "n_3_42", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
function N_n_3_42_rcvs_1(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        NT_add_setRight(N_n_3_42_state, G_msg_readFloatToken(m, 0))
        return
    }

                            throw new Error('Node "n_3_42", inlet "1", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_3_43_rcvs_0(m) {
                    ...
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_3_43_state, G_msg_readFloatToken(m, 0))
                        N_n_0_12_rcvs_0(G_msg_floats([N_n_3_43_state.leftOp + N_n_3_43_state.rightOp]))
                        return
...
function N_n_3_43_rcvs_1(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        NT_add_setRight(N_n_3_43_state, G_msg_readFloatToken(m, 0))
        return
    }

                            throw new Error('Node "n_3_43", inlet "1", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_3_44_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_add_setLeft(N_n_3_44_state, G_msg_readFloatToken(m, 0))
                        N_n_0_13_rcvs_0(G_msg_floats([N_n_3_44_state.leftOp + N_n_3_44_state.rightOp]))
                        return
                        ...
                        return
                            ...
                            throw new Error('Node "n_3_44", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
function N_n_3_44_rcvs_1(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        NT_add_setRight(N_n_3_44_state, G_msg_readFloatToken(m, 0))
        return
    }

                            throw new Error('Node "n_3_44", inlet "1", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_0_43_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_0_43_state.msgSpecs.splice(0, N_n_0_43_state.msgSpecs.length - 1)
                    N_n_0_43_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_0_43_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_0_43_state.msgSpecs.length; i++) {
                        if (N_n_0_43_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_0_43_state.msgSpecs[i].send, N_n_0_43_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_0_43_snds_0(N_n_0_43_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_0_44_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_0_44_state.msgSpecs.splice(0, N_n_0_44_state.msgSpecs.length - 1)
                    N_n_0_44_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_0_44_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_0_44_state.msgSpecs.length; i++) {
                        if (N_n_0_44_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_0_44_state.msgSpecs[i].send, N_n_0_44_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_0_44_snds_0(N_n_0_44_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_0_45_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_0_45_state.msgSpecs.splice(0, N_n_0_45_state.msgSpecs.length - 1)
                    N_n_0_45_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_0_45_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_0_45_state.msgSpecs.length; i++) {
                        if (N_n_0_45_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_0_45_state.msgSpecs[i].send, N_n_0_45_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_0_45_snds_0(N_n_0_45_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_0_rcvs_0(m) {
                            ...
                            if (
                                ...
                                N_n_3_6_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_7_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_8_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_9_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_10_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
...
function N_n_3_6_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_6_state, G_msg_readFloatToken(m, 0))
                N_n_3_42_rcvs_0(G_msg_floats([N_n_3_6_state.value]))
                return 
...
function N_n_3_6_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_6", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_7_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_7_state, G_msg_readFloatToken(m, 0))
                N_n_3_42_rcvs_0(G_msg_floats([N_n_3_7_state.value]))
                return 
...
function N_n_3_7_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_7", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_8_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_8_state, G_msg_readFloatToken(m, 0))
                N_n_3_42_rcvs_0(G_msg_floats([N_n_3_8_state.value]))
                return 
...
function N_n_3_8_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_8", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_9_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_9_state, G_msg_readFloatToken(m, 0))
                N_n_3_42_rcvs_0(G_msg_floats([N_n_3_9_state.value]))
                return 
...
function N_n_3_9_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_9", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_10_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_10_state, G_msg_readFloatToken(m, 0))
                N_n_3_42_rcvs_0(G_msg_floats([N_n_3_10_state.value]))
                return 
...
function N_n_3_10_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_10", inlet "1", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_3_1_rcvs_0(m) {
                            ...
                            if (
                                ...
                                N_n_3_14_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_13_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_12_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
                            ...
                            if (
                                ...
                                N_n_3_11_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
...
function N_n_3_15_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_15_state, G_msg_readFloatToken(m, 0))
                N_n_3_43_rcvs_0(G_msg_floats([N_n_3_15_state.value]))
                return 
...
function N_n_3_15_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_15", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_14_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_14_state, G_msg_readFloatToken(m, 0))
                N_n_3_43_rcvs_0(G_msg_floats([N_n_3_14_state.value]))
                return 
                ...
                return
                            ...
                            throw new Error('Node "n_3_14", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
function N_n_3_14_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_14", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_13_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_13_state, G_msg_readFloatToken(m, 0))
                N_n_3_43_rcvs_0(G_msg_floats([N_n_3_13_state.value]))
                return 
...
function N_n_3_13_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_13", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_12_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_12_state, G_msg_readFloatToken(m, 0))
                N_n_3_43_rcvs_0(G_msg_floats([N_n_3_12_state.value]))
                return 
...
function N_n_3_12_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_12", inlet "1", unsupported message : ' + G_msg_display(m))
                        }

function N_n_3_11_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_11_state, G_msg_readFloatToken(m, 0))
                N_n_3_43_rcvs_0(G_msg_floats([N_n_3_11_state.value]))
                return 
...
function N_n_3_11_rcvs_1(m) {
    ...
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        ...
        return
                            ...
                            throw new Error('Node "n_3_11", inlet "1", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_3_2_rcvs_0(m) {
                            ...
                            if (
                                ...
                                N_n_3_16_rcvs_0(G_bangUtils_emptyToBang(G_msgUtils_shift(m)))
                                return
                            }
...
function N_n_3_20_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                ...
                N_n_3_44_rcvs_0(G_msg_floats([N_n_3_20_state.value]))
                return 
...
function N_n_3_19_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                ...
                N_n_3_44_rcvs_0(G_msg_floats([N_n_3_19_state.value]))
                return 
...
function N_n_3_18_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                ...
                N_n_3_44_rcvs_0(G_msg_floats([N_n_3_18_state.value]))
                return 
...
function N_n_3_17_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                ...
                N_n_3_44_rcvs_0(G_msg_floats([N_n_3_17_state.value]))
                return 
...
function N_n_3_16_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_3_16_state, G_msg_readFloatToken(m, 0))
                N_n_3_44_rcvs_0(G_msg_floats([N_n_3_16_state.value]))
                return 
...
function N_n_3_31_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_31_state.msgSpecs.splice(0, N_n_3_31_state.msgSpecs.length - 1)
                    N_n_3_31_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_31_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_31_state.msgSpecs.length; i++) {
                        if (N_n_3_31_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_31_state.msgSpecs[i].send, N_n_3_31_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_31_snds_0(N_n_3_31_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_28_rcvs_0(m) {
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 4) === G_msg_FLOAT_TOKEN) {
                            N_n_3_10_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 4)]))
                        } else {
                            console.log('unpack : invalid token type index 4')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 3) === G_msg_FLOAT_TOKEN) {
                            N_n_3_9_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 3)]))
                        } else {
                            console.log('unpack : invalid token type index 3')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 2) === G_msg_FLOAT_TOKEN) {
                            N_n_3_8_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 2)]))
                        } else {
                            console.log('unpack : invalid token type index 2')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 1) === G_msg_FLOAT_TOKEN) {
                            N_n_3_7_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 1)]))
                        } else {
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 0) === G_msg_FLOAT_TOKEN) {
                            N_n_3_6_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 0)]))
                        } else {
...
function N_n_3_29_rcvs_0(m) {
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 4) === G_msg_FLOAT_TOKEN) {
                            N_n_3_11_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 4)]))
                        } else {
                            console.log('unpack : invalid token type index 4')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 3) === G_msg_FLOAT_TOKEN) {
                            N_n_3_12_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 3)]))
                        } else {
                            console.log('unpack : invalid token type index 3')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 2) === G_msg_FLOAT_TOKEN) {
                            N_n_3_13_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 2)]))
                        } else {
                            console.log('unpack : invalid token type index 2')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 1) === G_msg_FLOAT_TOKEN) {
                            N_n_3_14_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 1)]))
                        } else {
                            console.log('unpack : invalid token type index 1')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 0) === G_msg_FLOAT_TOKEN) {
                            N_n_3_15_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 0)]))
                        } else {
                            console.log('unpack : invalid token type index 0')
                        }
                    }
...
function N_n_3_30_rcvs_0(m) {
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 4) === G_msg_FLOAT_TOKEN) {
                            N_n_3_16_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 4)]))
                        } else {
                            console.log('unpack : invalid token type index 4')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 3) === G_msg_FLOAT_TOKEN) {
                            N_n_3_17_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 3)]))
                        } else {
                            console.log('unpack : invalid token type index 3')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 2) === G_msg_FLOAT_TOKEN) {
                            N_n_3_18_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 2)]))
                        } else {
                            console.log('unpack : invalid token type index 2')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 1) === G_msg_FLOAT_TOKEN) {
                            N_n_3_19_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 1)]))
                        } else {
                            console.log('unpack : invalid token type index 1')
                        }
                    }
                    ...
                    if (
                        ...
                        if (G_msg_getTokenType(m, 0) === G_msg_FLOAT_TOKEN) {
                            N_n_3_20_rcvs_1(G_msg_floats([G_msg_readFloatToken(m, 0)]))
                        } else {
                            console.log('unpack : invalid token type index 0')
                        }
                    }
...
function N_n_3_32_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_32_state.msgSpecs.splice(0, N_n_3_32_state.msgSpecs.length - 1)
                    N_n_3_32_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_32_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_32_state.msgSpecs.length; i++) {
                        if (N_n_3_32_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_32_state.msgSpecs[i].send, N_n_3_32_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_32_snds_0(N_n_3_32_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_33_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_33_state.msgSpecs.splice(0, N_n_3_33_state.msgSpecs.length - 1)
                    N_n_3_33_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_33_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_33_state.msgSpecs.length; i++) {
                        if (N_n_3_33_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_33_state.msgSpecs[i].send, N_n_3_33_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_33_snds_0(N_n_3_33_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_34_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_34_state.msgSpecs.splice(0, N_n_3_34_state.msgSpecs.length - 1)
                    N_n_3_34_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_34_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_34_state.msgSpecs.length; i++) {
                        if (N_n_3_34_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_34_state.msgSpecs[i].send, N_n_3_34_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_34_snds_0(N_n_3_34_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_3_34", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_3_35_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_35_state.msgSpecs.splice(0, N_n_3_35_state.msgSpecs.length - 1)
                    N_n_3_35_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_35_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_35_state.msgSpecs.length; i++) {
                        if (N_n_3_35_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_35_state.msgSpecs[i].send, N_n_3_35_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_35_snds_0(N_n_3_35_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_36_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_36_state.msgSpecs.splice(0, N_n_3_36_state.msgSpecs.length - 1)
                    N_n_3_36_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_36_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_36_state.msgSpecs.length; i++) {
                        if (N_n_3_36_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_36_state.msgSpecs[i].send, N_n_3_36_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_36_snds_0(N_n_3_36_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_3_37_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_3_37_state.msgSpecs.splice(0, N_n_3_37_state.msgSpecs.length - 1)
                    N_n_3_37_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_3_37_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_3_37_state.msgSpecs.length; i++) {
                        if (N_n_3_37_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_3_37_state.msgSpecs[i].send, N_n_3_37_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_3_37_snds_0(N_n_3_37_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_5_65_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_5_65_state.msgSpecs.splice(0, N_n_5_65_state.msgSpecs.length - 1)
                    N_n_5_65_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_5_65_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_5_65_state.msgSpecs.length; i++) {
                        if (N_n_5_65_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_5_65_state.msgSpecs[i].send, N_n_5_65_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_5_26_rcvs_0(N_n_5_65_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
...
function N_n_5_26_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        const value = G_msg_readFloatToken(m, 0)
                        N_n_5_64_rcvs_0(G_msg_floats([value <= 0 ? 0 : Math.exp(Math.LN10 * (value - 100) / 20)]))
                        return
                    }
                
                            throw new Error('Node "n_5_26", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_64_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_mul_setLeft(N_n_5_64_state, G_msg_readFloatToken(m, 0))
                        N_n_5_27_rcvs_0(G_msg_floats([N_n_5_64_state.leftOp * N_n_5_64_state.rightOp]))
                        return
...
function N_n_5_27_rcvs_0(m) {
            ...
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_5_27_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_5_27_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_5_27_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_5_27_state.floatValues[1])
    
            N_n_5_14_rcvs_0(messageOut)
            return
...
function N_n_5_14_rcvs_0(m) {
            ...
            if (
                ...
                switch (G_msg_getLength(m)) {
                    case 2:
                        NT_line_t_setNextDuration(N_n_5_14_state, G_msg_readFloatToken(m, 1))
                    case 1:
                        NT_line_t_setNewLine(N_n_5_14_state, G_msg_readFloatToken(m, 0))
                }
                return
    
            } else if (G_actionUtils_isAction(m, 'stop')) {
                NT_line_t_stop(N_n_5_14_state)
                return
...
function N_n_5_66_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_5_66_state.msgSpecs.splice(0, N_n_5_66_state.msgSpecs.length - 1)
                    N_n_5_66_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_5_66_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_5_66_state.msgSpecs.length; i++) {
                        if (N_n_5_66_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_5_66_state.msgSpecs[i].send, N_n_5_66_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_5_33_rcvs_0(N_n_5_66_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_5_66", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_33_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_n_5_32_rcvs_0(G_msg_floats([
                    Math.max(
                        Math.min(
                            N_n_5_33_state.maxValue, 
                            G_msg_readFloatToken(m, 0)
                        ), 
                        N_n_5_33_state.minValue
                    )
                ]))
                return
            }
...
function N_n_5_32_rcvs_0(m) {
                    ...
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_div_setLeft(N_n_5_32_state, G_msg_readFloatToken(m, 0))
                        N_n_5_28_rcvs_0(G_msg_floats([N_n_5_32_state.rightOp !== 0 ? N_n_5_32_state.leftOp / N_n_5_32_state.rightOp: 0]))
                        return
...
function N_n_5_28_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_5_28_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_5_28_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_5_28_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_5_28_state.floatValues[1])
    
            N_n_5_15_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_5_28", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_n_5_15_outs_0 = 0
function N_n_5_15_rcvs_0(m) {
            ...
            if (
                ...
                switch (G_msg_getLength(m)) {
                    case 2:
                        NT_line_t_setNextDuration(N_n_5_15_state, G_msg_readFloatToken(m, 1))
                    case 1:
                        NT_line_t_setNewLine(N_n_5_15_state, G_msg_readFloatToken(m, 0))
                }
                return
    
            } else if (G_actionUtils_isAction(m, 'stop')) {
                NT_line_t_stop(N_n_5_15_state)
                return
...
function N_n_5_67_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_5_67_state.msgSpecs.splice(0, N_n_5_67_state.msgSpecs.length - 1)
                    N_n_5_67_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_5_67_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_5_67_state.msgSpecs.length; i++) {
                        if (N_n_5_67_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_5_67_state.msgSpecs[i].send, N_n_5_67_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_5_40_rcvs_0(N_n_5_67_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_5_67", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
...
function N_n_5_40_rcvs_0(m) {
            ...
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                const value = G_msg_readFloatToken(m, 0)
                if (value >= N_n_5_40_state.threshold) {
                    N_n_5_44_rcvs_0(G_msg_floats([value]))
                } else {
                    N_n_5_41_rcvs_0(G_msg_floats([value]))
                }
                return
            }
...
function N_n_5_41_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_5_41_state.msgSpecs.splice(0, N_n_5_41_state.msgSpecs.length - 1)
                    N_n_5_41_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_5_41_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_5_41_state.msgSpecs.length; i++) {
                        if (N_n_5_41_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_5_41_state.msgSpecs[i].send, N_n_5_41_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_5_44_rcvs_0(N_n_5_41_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_5_41", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_44_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_5_44_state, G_msg_readFloatToken(m, 0))
                N_n_5_44_snds_0(G_msg_floats([N_n_5_44_state.value]))
                return 
                ...
                return
                            ...
                            throw new Error('Node "n_5_44", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_5_34_1__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_5_34_1__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_5_34_1__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_5_34_1_sig_outs_0 = 0
function N_m_n_5_34_1_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_5_34_1_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_5_34_1_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_5_52_1__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_5_52_1__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_5_52_1__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_5_52_1_sig_outs_0 = 0
function N_m_n_5_52_1_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_5_52_1_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_5_52_1_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_5_56_1__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_5_56_1__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_5_56_1__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_5_56_1_sig_outs_0 = 0
function N_m_n_5_56_1_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_5_56_1_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_5_56_1_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_m_n_5_60_1__routemsg_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_m_n_5_60_1__routemsg_snds_0(m)
                return
            } else {
                G_msg_VOID_MESSAGE_RECEIVER(m)
                return
                            ...
                            throw new Error('Node "m_n_5_60_1__routemsg", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_m_n_5_60_1_sig_outs_0 = 0
function N_m_n_5_60_1_sig_rcvs_0(m) {
                            
    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
        N_m_n_5_60_1_sig_state.currentValue = G_msg_readFloatToken(m, 0)
        return
    }

                            throw new Error('Node "m_n_5_60_1_sig", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_68_rcvs_0(m) {
                ...
                if (
                    ...
                    N_n_5_68_state.msgSpecs.splice(0, N_n_5_68_state.msgSpecs.length - 1)
                    N_n_5_68_state.msgSpecs[0] = {
                        transferFunction: function (m) {
                            return N_n_5_68_state.msgSpecs[0].outMessage
                        },
                        outTemplate: outTemplate,
                        outMessage: outMessage,
                        send: "",
                    ...
                    for (let i = 0; i < N_n_5_68_state.msgSpecs.length; i++) {
                        if (N_n_5_68_state.msgSpecs[i].hasSend) {
                            G_msgBuses_publish(N_n_5_68_state.msgSpecs[i].send, N_n_5_68_state.msgSpecs[i].transferFunction(m))
                        } else {
                            N_n_5_42_rcvs_0(N_n_5_68_state.msgSpecs[i].transferFunction(m))
                        }
                    }
                    return
                }
            
                            throw new Error('Node "n_5_68", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_42_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                N_n_5_45_rcvs_0(G_msg_floats([
                    Math.max(
                        Math.min(
                            N_n_5_42_state.maxValue, 
                            G_msg_readFloatToken(m, 0)
                        ), 
                        N_n_5_42_state.minValue
                    )
                ]))
                return
            }
        
                            throw new Error('Node "n_5_42", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_45_rcvs_0(m) {
                            
            if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                NT_float_setValue(N_n_5_45_state, G_msg_readFloatToken(m, 0))
                N_n_5_46_rcvs_0(G_msg_floats([N_n_5_45_state.value]))
                return 
...
function N_n_5_46_rcvs_0(m) {
                            
                    if (G_msg_isMatching(m, [G_msg_FLOAT_TOKEN])) {
                        NT_mul_setLeft(N_n_5_46_state, G_msg_readFloatToken(m, 0))
                        N_n_5_47_rcvs_0(G_msg_floats([N_n_5_46_state.leftOp * N_n_5_46_state.rightOp]))
                        return
                        ...
                        return
                            ...
                            throw new Error('Node "n_5_46", inlet "0", unsupported message : ' + G_msg_display(m))
                        }

function N_n_5_47_rcvs_0(m) {
                            
            if (!G_bangUtils_isBang(m)) {
                for (let i = 0; i < G_msg_getLength(m); i++) {
                    N_n_5_47_state.stringValues[i] = G_tokenConversion_toString_(m, i)
                    N_n_5_47_state.floatValues[i] = G_tokenConversion_toFloat(m, i)
                }
            }
            ...
            G_msg_writeFloatToken(messageOut, 0, N_n_5_47_state.floatValues[0])
G_msg_writeFloatToken(messageOut, 1, N_n_5_47_state.floatValues[1])
    
            N_n_5_48_rcvs_0(messageOut)
            return
        
                            throw new Error('Node "n_5_47", inlet "0", unsupported message : ' + G_msg_display(m))
                        }
let N_n_5_48_outs_0 = 0
function N_n_5_48_rcvs_0(m) {
            ...
            if (
                ...
                switch (G_msg_getLength(m)) {
                    case 2:
                        NT_line_t_setNextDuration(N_n_5_48_state, G_msg_readFloatToken(m, 1))
                    case 1:
                        NT_line_t_setNewLine(N_n_5_48_state, G_msg_readFloatToken(m, 0))
                }
                return
    
            } else if (G_actionUtils_isAction(m, 'stop')) {
                NT_line_t_stop(N_n_5_48_state)
                return
...
let N_n_0_33_outs_0 = 0

let N_m_n_6_14_0_sig_outs_0 = 0

let N_n_6_14_outs_0 = 0

let N_n_6_1_outs_0 = 0

let N_m_n_6_16_0_sig_outs_0 = 0

let N_n_6_16_outs_0 = 0

let N_n_6_2_outs_0 = 0

let N_m_n_6_18_0_sig_outs_0 = 0

let N_n_6_18_outs_0 = 0

let N_n_6_5_outs_0 = 0

let N_m_n_6_20_0_sig_outs_0 = 0

let N_n_6_20_outs_0 = 0

let N_n_6_7_outs_0 = 0

let N_m_n_6_24_0_sig_outs_0 = 0

let N_n_6_24_outs_0 = 0
...
let N_n_5_9_outs_0 = 0





let N_m_n_6_22_0_sig_outs_0 = 0

let N_n_6_22_outs_0 = 0

let N_m_n_5_17_0_sig_outs_0 = 0

let N_n_5_17_outs_0 = 0

let N_n_5_52_outs_0 = 0
...
let N_m_n_5_19_0_sig_outs_0 = 0

let N_n_5_19_outs_0 = 0

let N_n_5_60_outs_0 = 0
...
let N_n_5_12_outs_0 = 0





let N_n_5_13_outs_0 = 0

let N_n_5_11_outs_0 = 0
...
function N_m_n_7_2_0__routemsg_snds_0(m) {
                        N_m_n_7_2_0_sig_rcvs_0(m)
COLD_1(m)
                    }
...
function N_m_n_8_2_0__routemsg_snds_0(m) {
                        N_m_n_8_2_0_sig_rcvs_0(m)
COLD_2(m)
                    }
...
function N_n_0_37_snds_0(m) {
                        N_n_0_26_rcvs_1(m)
N_n_ioSnd_n_0_37_0_rcvs_0(m)
                    }
...
function N_n_3_31_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_32_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_33_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_34_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_35_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_36_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_3_37_snds_0(m) {
                        N_n_3_28_rcvs_0(m)
N_n_3_29_rcvs_0(m)
N_n_3_30_rcvs_0(m)
                    }
function N_n_5_35_snds_0(m) {
                        N_n_5_65_rcvs_0(m)
N_n_5_66_rcvs_0(m)
N_n_5_67_rcvs_0(m)
N_n_5_68_rcvs_0(m)
                    }
function N_n_5_44_snds_0(m) {
                        N_m_n_5_34_1__routemsg_rcvs_0(m)
N_m_n_5_52_1__routemsg_rcvs_0(m)
N_m_n_5_56_1__routemsg_rcvs_0(m)
N_m_n_5_60_1__routemsg_rcvs_0(m)
                    }
function N_m_n_5_34_1__routemsg_snds_0(m) {
                        N_m_n_5_34_1_sig_rcvs_0(m)
COLD_9(m)
                    }
function N_m_n_5_52_1__routemsg_snds_0(m) {
                        N_m_n_5_52_1_sig_rcvs_0(m)
COLD_12(m)
                    }
function N_m_n_5_56_1__routemsg_snds_0(m) {
                        N_m_n_5_56_1_sig_rcvs_0(m)
COLD_14(m)
                    }
function N_m_n_5_60_1__routemsg_snds_0(m) {
                        N_m_n_5_60_1_sig_rcvs_0(m)
COLD_16(m)
                    }
...
function COLD_1(m) {
                    N_m_n_7_2_0_sig_outs_0 = N_m_n_7_2_0_sig_state.currentValue
                    NT_osc_t_setStep(N_n_7_2_state, N_m_n_7_2_0_sig_outs_0)
                }
function COLD_2(m) {
                    N_m_n_8_2_0_sig_outs_0 = N_m_n_8_2_0_sig_state.currentValue
                    NT_osc_t_setStep(N_n_8_2_state, N_m_n_8_2_0_sig_outs_0)
                }
function COLD_3(m) {
                    N_m_n_6_14_0_sig_outs_0 = N_m_n_6_14_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_14_state, N_m_n_6_14_0_sig_outs_0)
                }
function COLD_4(m) {
                    N_m_n_6_16_0_sig_outs_0 = N_m_n_6_16_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_16_state, N_m_n_6_16_0_sig_outs_0)
                }
function COLD_5(m) {
                    N_m_n_6_18_0_sig_outs_0 = N_m_n_6_18_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_18_state, N_m_n_6_18_0_sig_outs_0)
                }
function COLD_6(m) {
                    N_m_n_6_20_0_sig_outs_0 = N_m_n_6_20_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_20_state, N_m_n_6_20_0_sig_outs_0)
                }
function COLD_7(m) {
                    N_m_n_6_24_0_sig_outs_0 = N_m_n_6_24_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_24_state, N_m_n_6_24_0_sig_outs_0)
                }
function COLD_8(m) {
...
function COLD_9(m) {
                    N_m_n_5_34_1_sig_outs_0 = N_m_n_5_34_1_sig_state.currentValue
                    NT_lop_t_setFreq(N_n_5_34_state, N_m_n_5_34_1_sig_outs_0)
                }
function COLD_10(m) {
                    N_m_n_6_22_0_sig_outs_0 = N_m_n_6_22_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_6_22_state, N_m_n_6_22_0_sig_outs_0)
                }
function COLD_11(m) {
                    N_m_n_5_17_0_sig_outs_0 = N_m_n_5_17_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_5_17_state, N_m_n_5_17_0_sig_outs_0)
                }
function COLD_12(m) {
                    N_m_n_5_52_1_sig_outs_0 = N_m_n_5_52_1_sig_state.currentValue
                    NT_lop_t_setFreq(N_n_5_52_state, N_m_n_5_52_1_sig_outs_0)
                }
function COLD_13(m) {
...
function COLD_14(m) {
                    N_m_n_5_56_1_sig_outs_0 = N_m_n_5_56_1_sig_state.currentValue
                    NT_lop_t_setFreq(N_n_5_56_state, N_m_n_5_56_1_sig_outs_0)
                }
function COLD_15(m) {
                    N_m_n_5_19_0_sig_outs_0 = N_m_n_5_19_0_sig_state.currentValue
                    NT_delread_t_setRawOffset(N_n_5_19_state, N_m_n_5_19_0_sig_outs_0)
                }
function COLD_16(m) {
                    N_m_n_5_60_1_sig_outs_0 = N_m_n_5_60_1_sig_state.currentValue
                    NT_lop_t_setFreq(N_n_5_60_state, N_m_n_5_60_1_sig_outs_0)
                }
...
const IO_snd_n_0_37_0 = (m) => {exports.io.messageSenders['n_0_37']['0'](m)}
...
const IO_snd_n_0_42_0 = (m) => {exports.io.messageSenders['n_0_42']['0'](m)}
        ...
        const exports = {
            metadata: {"libVersion":"0.1.0","customMetadata":{"pdNodes":{"0":{"0":{"id":"0","type":"tgl","args":[1,0,0,"",""],"nodeClass":"control","layout":{"x":41,"y":144,"size":18,"label":"on/off","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"4":{"id":"4","type":"bng","args":[0,"","giaale"],"nodeClass":"control","layout":{"x":356,"y":166,"size":18,"hold":250,"interrupt":50,"label":"get_giaale","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"5":{"id":"5","type":"bng","args":[0,"","mera"],"nodeClass":"control","layout":{"x":356,"y":189,"size":18,"hold":250,"interrupt":50,"label":"get_mera","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"6":{"id":"6","type":"bng","args":[0,"","poan"],"nodeClass":"control","layout":{"x":356,"y":212,"size":18,"hold":250,"interrupt":50,"label":"get_poan","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"7":{"id":"7","type":"bng","args":[0,"","maisia"],"nodeClass":"control","layout":{"x":356,"y":235,"size":18,"hold":250,"interrupt":50,"label":"get_maisia","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"8":{"id":"8","type":"bng","args":[0,"","bagat"],"nodeClass":"control","layout":{"x":356,"y":258,"size":18,"hold":250,"interrupt":50,"label":"get_bagat","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"9":{"id":"9","type":"bng","args":[0,"","mazand"],"nodeClass":"control","layout":{"x":356,"y":281,"size":18,"hold":250,"interrupt":50,"label":"get_mazand","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"10":{"id":"10","type":"bng","args":[0,"","rastad"],"nodeClass":"control","layout":{"x":356,"y":304,"size":18,"hold":250,"interrupt":50,"label":"get_rastad","labelX":21,"labelY":8,"labelFont":"0","labelFontSize":10,"bgColor":"#fcfcfc","fgColor":"#000000","labelColor":"#000000"}},"35":{"id":"35","type":"msg","args":[1000],"nodeClass":"control","layout":{"x":113,"y":75}},"36":{"id":"36","type":"msg","args":[2000],"nodeClass":"control","layout":{"x":158,"y":75}},"37":{"id":"37","type":"msg","args":[4000],"nodeClass":"control","layout":{"x":203,"y":75}},"43":{"id":"43","type":"msg","args":[12],"nodeClass":"control","layout":{"x":56,"y":305}},"44":{"id":"44","type":"msg","args":[0],"nodeClass":"control","layout":{"x":101,"y":305}},"45":{"id":"45","type":"msg","args":[-12],"nodeClass":"control","layout":{"x":146,"y":305}}}},"graph":{"n_0_0":{"id":"n_0_0","type":"tgl","args":{"minValue":0,"maxValue":1,"sendBusName":"empty","receiveBusName":"empty","initValue":0,"outputOnLoad":false},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_0_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_34","portletId":"0"},{"nodeId":"n_ioSnd_n_0_0_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_4":{"id":"n_0_4","type":"bang","args":{"outputOnLoad":false,"sendBusName":"giaale","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_0_22","portletId":"0"},{"nodeId":"n_ioRcv_n_0_4_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_4_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_5":{"id":"n_0_5","type":"bang","args":{"outputOnLoad":false,"sendBusName":"mera","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_5_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_5_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_6":{"id":"n_0_6","type":"bang","args":{"outputOnLoad":false,"sendBusName":"poan","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_6_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_6_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_7":{"id":"n_0_7","type":"bang","args":{"outputOnLoad":false,"sendBusName":"maisia","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_7_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_7_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_8":{"id":"n_0_8","type":"bang","args":{"outputOnLoad":false,"sendBusName":"bagat","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_8_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_8_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_9":{"id":"n_0_9","type":"bang","args":{"outputOnLoad":false,"sendBusName":"mazand","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_9_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_9_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_10":{"id":"n_0_10","type":"bang","args":{"outputOnLoad":false,"sendBusName":"rastad","receiveBusName":"empty"},"sources":{"0":[{"nodeId":"n_ioRcv_n_0_10_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_ioSnd_n_0_10_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_35":{"id":"n_0_35","type":"msg","args":{"msgSpecs":[{"tokens":[1000],"send":null}]},"sources":{"0":[{"nodeId":"n_0_27","portletId":"0"},{"nodeId":"n_ioRcv_n_0_35_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_26","portletId":"1"},{"nodeId":"n_ioSnd_n_0_35_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_36":{"id":"n_0_36","type":"msg","args":{"msgSpecs":[{"tokens":[2000],"send":null}]},"sources":{"0":[{"nodeId":"n_0_28","portletId":"0"},{"nodeId":"n_ioRcv_n_0_36_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_26","portletId":"1"},{"nodeId":"n_ioSnd_n_0_36_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_37":{"id":"n_0_37","type":"msg","args":{"msgSpecs":[{"tokens":[4000],"send":null}]},"sources":{"0":[{"nodeId":"n_0_29","portletId":"0"},{"nodeId":"n_ioRcv_n_0_37_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_26","portletId":"1"},{"nodeId":"n_ioSnd_n_0_37_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_43":{"id":"n_0_43","type":"msg","args":{"msgSpecs":[{"tokens":[12],"send":null}]},"sources":{"0":[{"nodeId":"n_0_39","portletId":"0"},{"nodeId":"n_ioRcv_n_0_43_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_38","portletId":"1"},{"nodeId":"n_ioSnd_n_0_43_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_44":{"id":"n_0_44","type":"msg","args":{"msgSpecs":[{"tokens":[0],"send":null}]},"sources":{"0":[{"nodeId":"n_0_40","portletId":"0"},{"nodeId":"n_ioRcv_n_0_44_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_38","portletId":"1"},{"nodeId":"n_ioSnd_n_0_44_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_45":{"id":"n_0_45","type":"msg","args":{"msgSpecs":[{"tokens":[-12],"send":null}]},"sources":{"0":[{"nodeId":"n_0_41","portletId":"0"},{"nodeId":"n_ioRcv_n_0_45_0","portletId":"0"}]},"sinks":{"0":[{"nodeId":"n_0_38","portletId":"1"},{"nodeId":"n_ioSnd_n_0_45_0","portletId":"0"}]},"inlets":{"0":{"type":"message","id":"0"}},"outlets":{"0":{"type":"message","id":"0"}}},"n_0_11":{"id":"n_0_11","type":"send","args":{"busName":"note1"},"sources":{"0":[{"nodeId":"n_3_42","portletId":"0"},{"nodeId":"n_ioRcv_n_0_11_0","portletId":"0"}]},"sinks":{},"inlets":{"0":{"type":"message","id":"0"},"1":{"type":"message","id":"1"}},"outlets":{}},"n_0_12":{"id":"n_0_12","type":"send","args":{"busName":"note2"},"sources":{"0":[{"nodeId":"n_3_43","portletId":"0"},{"nodeId":"n_ioRcv_n_0_12_0","portletId":"0"}]},"sinks":{},"inlets":{"0":{"type":"message","id":"0"},"1":{"type":"message","id":"1"}},"outlets":{}},"n_0_13":{"id":"n_0_13","type":"send","args":{"busName":"note3"},"sources":{"0":[{"nodeId":"n_3_44","portletId":"0"},{"nodeId":"n_ioRcv_n_0_13_0","portletId":"0"}]},"sinks":{},"inlets":{"0":{"type":"message","id":"0"},"1":{"type":"message","id":"1"}},"outlets":{}},"n_0_23":{"id":"n_0_23","type":"send","args":{"busName":"trig"},"sources":{"0":[{"nodeId":"n_0_34","portletId":"0"},{"nodeId":"n_ioRcv_n_0_23_0","portletId":"0"}]},"sinks":{},"inlets":{"0":{"type":"message","id":"0"},"1":{"type":"message","id":"1"}},"outlets":{}},"n_0_14":{"id":"n_0_14","type":"receive","args":{"busName":"note1"},"sources":{},"sinks":{"0":[{"nodeId":"n_4_13","portletId":"0"},{"nodeId":"n_ioSnd_n_0_14_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_16":{"id":"n_0_16","type":"receive","args":{"busName":"note2"},"sources":{},"sinks":{"0":[{"nodeId":"n_7_12","portletId":"0"},{"nodeId":"n_ioSnd_n_0_16_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_19":{"id":"n_0_19","type":"receive","args":{"busName":"note3"},"sources":{},"sinks":{"0":[{"nodeId":"n_8_12","portletId":"0"},{"nodeId":"n_ioSnd_n_0_19_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_27":{"id":"n_0_27","type":"receive","args":{"busName":"neba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_35","portletId":"0"},{"nodeId":"n_ioSnd_n_0_27_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_28":{"id":"n_0_28","type":"receive","args":{"busName":"saba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_36","portletId":"0"},{"nodeId":"n_ioSnd_n_0_28_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_29":{"id":"n_0_29","type":"receive","args":{"busName":"reba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_37","portletId":"0"},{"nodeId":"n_ioSnd_n_0_29_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_30":{"id":"n_0_30","type":"receive","args":{"busName":"trig"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_26","portletId":"0"},{"nodeId":"n_ioSnd_n_0_30_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_39":{"id":"n_0_39","type":"receive","args":{"busName":"neba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_43","portletId":"0"},{"nodeId":"n_ioSnd_n_0_39_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_40":{"id":"n_0_40","type":"receive","args":{"busName":"saba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_44","portletId":"0"},{"nodeId":"n_ioSnd_n_0_40_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_41":{"id":"n_0_41","type":"receive","args":{"busName":"reba"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_45","portletId":"0"},{"nodeId":"n_ioSnd_n_0_41_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true},"n_0_42":{"id":"n_0_42","type":"receive","args":{"busName":"trig"},"sources":{},"sinks":{"0":[{"nodeId":"n_0_38","portletId":"0"},{"nodeId":"n_ioSnd_n_0_42_0","portletId":"0"}]},"inlets":{},"outlets":{"0":{"type":"message","id":"0"}},"isPushingMessages":true}},"pdGui":[{"nodeClass":"control","patchId":"0","pdNodeId":"0","nodeId":"n_0_0"},{"nodeClass":"control","patchId":"0","pdNodeId":"4","nodeId":"n_0_4"},{"nodeClass":"control","patchId":"0","pdNodeId":"5","nodeId":"n_0_5"},{"nodeClass":"control","patchId":"0","pdNodeId":"6","nodeId":"n_0_6"},{"nodeClass":"control","patchId":"0","pdNodeId":"7","nodeId":"n_0_7"},{"nodeClass":"control","patchId":"0","pdNodeId":"8","nodeId":"n_0_8"},{"nodeClass":"control","patchId":"0","pdNodeId":"9","nodeId":"n_0_9"},{"nodeClass":"control","patchId":"0","pdNodeId":"10","nodeId":"n_0_10"},{"nodeClass":"control","patchId":"0","pdNodeId":"35","nodeId":"n_0_35"},{"nodeClass":"control","patchId":"0","pdNodeId":"36","nodeId":"n_0_36"},{"nodeClass":"control","patchId":"0","pdNodeId":"37","nodeId":"n_0_37"},{"nodeClass":"control","patchId":"0","pdNodeId":"43","nodeId":"n_0_43"},{"nodeClass":"control","patchId":"0","pdNodeId":"44","nodeId":"n_0_44"},{"nodeClass":"control","patchId":"0","pdNodeId":"45","nodeId":"n_0_45"}]},"settings":{"audio":{"channelCount":{"in":2,"out":2},"bitDepth":64,"sampleRate":0,"blockSize":0},"io":{"messageReceivers":{"n_0_0":["0"],"n_0_4":["0"],"n_0_5":["0"],"n_0_6":["0"],"n_0_7":["0"],"n_0_8":["0"],"n_0_9":["0"],"n_0_10":["0"],"n_0_35":["0"],"n_0_36":["0"],"n_0_37":["0"],"n_0_43":["0"],"n_0_44":["0"],"n_0_45":["0"],"n_0_11":["0"],"n_0_12":["0"],"n_0_13":["0"],"n_0_23":["0"]},"messageSenders":{"n_0_0":["0"],"n_0_4":["0"],"n_0_5":["0"],"n_0_6":["0"],"n_0_7":["0"],"n_0_8":["0"],"n_0_9":["0"],"n_0_10":["0"],"n_0_35":["0"],"n_0_36":["0"],"n_0_37":["0"],"n_0_43":["0"],"n_0_44":["0"],"n_0_45":["0"],"n_0_14":["0"],"n_0_16":["0"],"n_0_19":["0"],"n_0_27":["0"],"n_0_28":["0"],"n_0_29":["0"],"n_0_30":["0"],"n_0_39":["0"],"n_0_40":["0"],"n_0_41":["0"],"n_0_42":["0"]}}},"compilation":{"variableNamesIndex":{"io":{"messageReceivers":{"n_0_0":{"0":"IO_rcv_n_0_0_0"},"n_0_4":{"0":"IO_rcv_n_0_4_0"},"n_0_5":{"0":"IO_rcv_n_0_5_0"},"n_0_6":{"0":"IO_rcv_n_0_6_0"},"n_0_7":{"0":"IO_rcv_n_0_7_0"},"n_0_8":{"0":"IO_rcv_n_0_8_0"},"n_0_9":{"0":"IO_rcv_n_0_9_0"},"n_0_10":{"0":"IO_rcv_n_0_10_0"},"n_0_35":{"0":"IO_rcv_n_0_35_0"},"n_0_36":{"0":"IO_rcv_n_0_36_0"},"n_0_37":{"0":"IO_rcv_n_0_37_0"},"n_0_43":{"0":"IO_rcv_n_0_43_0"},"n_0_44":{"0":"IO_rcv_n_0_44_0"},"n_0_45":{"0":"IO_rcv_n_0_45_0"},"n_0_11":{"0":"IO_rcv_n_0_11_0"},"n_0_12":{"0":"IO_rcv_n_0_12_0"},"n_0_13":{"0":"IO_rcv_n_0_13_0"},"n_0_23":{"0":"IO_rcv_n_0_23_0"}},"messageSenders":{"n_0_0":{"0":"IO_snd_n_0_0_0"},"n_0_4":{"0":"IO_snd_n_0_4_0"},"n_0_5":{"0":"IO_snd_n_0_5_0"},"n_0_6":{"0":"IO_snd_n_0_6_0"},"n_0_7":{"0":"IO_snd_n_0_7_0"},"n_0_8":{"0":"IO_snd_n_0_8_0"},"n_0_9":{"0":"IO_snd_n_0_9_0"},"n_0_10":{"0":"IO_snd_n_0_10_0"},"n_0_35":{"0":"IO_snd_n_0_35_0"},"n_0_36":{"0":"IO_snd_n_0_36_0"},"n_0_37":{"0":"IO_snd_n_0_37_0"},"n_0_43":{"0":"IO_snd_n_0_43_0"},"n_0_44":{"0":"IO_snd_n_0_44_0"},"n_0_45":{"0":"IO_snd_n_0_45_0"},"n_0_14":{"0":"IO_snd_n_0_14_0"},"n_0_16":{"0":"IO_snd_n_0_16_0"},"n_0_19":{"0":"IO_snd_n_0_19_0"},"n_0_27":{"0":"IO_snd_n_0_27_0"},"n_0_28":{"0":"IO_snd_n_0_28_0"},"n_0_29":{"0":"IO_snd_n_0_29_0"},"n_0_30":{"0":"IO_snd_n_0_30_0"},"n_0_39":{"0":"IO_snd_n_0_39_0"},"n_0_40":{"0":"IO_snd_n_0_40_0"},"n_0_41":{"0":"IO_snd_n_0_41_0"},"n_0_42":{"0":"IO_snd_n_0_42_0"}}},"globals":{"commons":{"getArray":"G_commons_getArray","setArray":"G_commons_setArray"}}}}},
            ...
            N_n_0_34_state.snd0 = N_n_0_23_rcvs_0
            N_n_0_34_state.sampleRatio = computeUnitInSamples(SAMPLE_RATE, 1, "msec")
            NT_metro_setRate(N_n_0_34_state, 1000)
        ...
        NT_bang_setReceiveBusName(N_n_0_10_state, "empty")
            ...
            NT_add_setLeft(N_n_4_14_state, 0)
            NT_add_setRight(N_n_4_14_state, 19)
        




            N_n_4_12_state.msgSpecs = [
...
N_n_4_12_state.msgSpecs[0].outTemplate = []

                N_n_4_12_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_4_12_state.msgSpecs[0].outMessage = G_msg_create(N_n_4_12_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_4_12_state.msgSpecs[0].outMessage, 0, 1)
        ...
        N_n_4_17_state.sampleRatio = computeUnitInSamples(SAMPLE_RATE, 1, "msec")
        NT_delay_setDelay(N_n_4_17_state, 900)
            ...
            NT_add_setLeft(N_n_7_14_state, 0)
            NT_add_setRight(N_n_7_14_state, 19)
        




            N_n_7_13_state.msgSpecs = [
...
N_n_7_13_state.msgSpecs[0].outTemplate = []

                N_n_7_13_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_7_13_state.msgSpecs[0].outMessage = G_msg_create(N_n_7_13_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_7_13_state.msgSpecs[0].outMessage, 0, 0.75)
        ...
        N_n_7_17_state.sampleRatio = computeUnitInSamples(SAMPLE_RATE, 1, "msec")
        NT_delay_setDelay(N_n_7_17_state, 900)
            ...
            NT_add_setLeft(N_n_8_13_state, 0)
            NT_add_setRight(N_n_8_13_state, 19)
        




            N_n_8_15_state.msgSpecs = [
...
N_n_8_15_state.msgSpecs[0].outTemplate = []

                N_n_8_15_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_8_15_state.msgSpecs[0].outMessage = G_msg_create(N_n_8_15_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_8_15_state.msgSpecs[0].outMessage, 0, 0.75)
        ...
        N_n_8_17_state.sampleRatio = computeUnitInSamples(SAMPLE_RATE, 1, "msec")
        NT_delay_setDelay(N_n_8_17_state, 900)
    


G_commons_waitFrame(0, () => N_n_0_4_rcvs_0(G_bangUtils_bang()))

            NT_float_setValue(N_n_0_26_state, 0)
        

            G_msgBuses_subscribe("neba", N_n_0_27_snds_0)
        

            N_n_0_35_state.msgSpecs = [
...
N_n_0_35_state.msgSpecs[0].outTemplate = []

                N_n_0_35_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_35_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_35_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_35_state.msgSpecs[0].outMessage, 0, 1000)
            
        



            G_msgBuses_subscribe("saba", N_n_0_28_snds_0)
...
N_n_0_36_state.msgSpecs[0].outTemplate = []
                ...
                N_n_0_36_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_36_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_36_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_36_state.msgSpecs[0].outMessage, 0, 2000)
            
        



            G_msgBuses_subscribe("reba", N_n_0_29_snds_0)
...
N_n_0_37_state.msgSpecs[0].outTemplate = []
                ...
                N_n_0_37_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_37_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_37_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_37_state.msgSpecs[0].outMessage, 0, 4000)
            
        



            G_msgBuses_subscribe("trig", N_n_0_30_snds_0)
        


            NT_float_setValue(N_n_0_38_state, 0)
        

            NT_add_setLeft(N_n_3_42_state, 0)
            NT_add_setRight(N_n_3_42_state, 0)
        


            NT_add_setLeft(N_n_3_43_state, 0)
            NT_add_setRight(N_n_3_43_state, 0)
        


            NT_add_setLeft(N_n_3_44_state, 0)
            NT_add_setRight(N_n_3_44_state, 0)
        


            G_msgBuses_subscribe("neba", N_n_0_39_snds_0)
        

            N_n_0_43_state.msgSpecs = [
...
N_n_0_43_state.msgSpecs[0].outTemplate = []

                N_n_0_43_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_43_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_43_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_43_state.msgSpecs[0].outMessage, 0, 12)
            
        



            G_msgBuses_subscribe("saba", N_n_0_40_snds_0)
        

            N_n_0_44_state.msgSpecs = [
...
N_n_0_44_state.msgSpecs[0].outTemplate = []

                N_n_0_44_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_44_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_44_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_44_state.msgSpecs[0].outMessage, 0, 0)
            
        



            G_msgBuses_subscribe("reba", N_n_0_41_snds_0)
        

            N_n_0_45_state.msgSpecs = [
...
N_n_0_45_state.msgSpecs[0].outTemplate = []

                N_n_0_45_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_0_45_state.msgSpecs[0].outMessage = G_msg_create(N_n_0_45_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_0_45_state.msgSpecs[0].outMessage, 0, -12)
            
        



            G_msgBuses_subscribe("trig", N_n_0_42_snds_0)
...
N_n_2_12_state.msgSpecs[0].outMessage = G_msg_create(N_n_2_12_state.msgSpecs[0].outTemplate)
            ...
            G_msgBuses_subscribe("root", N_n_3_0_rcvs_0)
        


            NT_float_setValue(N_n_3_6_state, 0)
        

            NT_float_setValue(N_n_3_7_state, 0)
        

            NT_float_setValue(N_n_3_8_state, 0)
        

            NT_float_setValue(N_n_3_9_state, 0)
        

            NT_float_setValue(N_n_3_10_state, 0)
        

            G_msgBuses_subscribe("chord1", N_n_3_1_rcvs_0)
        


            NT_float_setValue(N_n_3_15_state, 0)
        

            NT_float_setValue(N_n_3_14_state, 0)
        

            NT_float_setValue(N_n_3_13_state, 0)
        

            NT_float_setValue(N_n_3_12_state, 0)
        

            NT_float_setValue(N_n_3_11_state, 0)
        

            G_msgBuses_subscribe("chord2", N_n_3_2_rcvs_0)
            ...
            NT_float_setValue(N_n_3_16_state, 0)
        

            G_msgBuses_subscribe("giaale", N_n_3_31_rcvs_0)
        

            N_n_3_31_state.msgSpecs = [
...
N_n_3_31_state.msgSpecs[0].outTemplate = []

                N_n_3_31_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_31_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_31_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_31_state.msgSpecs[0].outMessage, 0, 68)
            

                G_msg_writeFloatToken(N_n_3_31_state.msgSpecs[0].outMessage, 1, 67)
            

                G_msg_writeFloatToken(N_n_3_31_state.msgSpecs[0].outMessage, 2, 63)
            

                G_msg_writeFloatToken(N_n_3_31_state.msgSpecs[0].outMessage, 3, 62)
            

                G_msg_writeFloatToken(N_n_3_31_state.msgSpecs[0].outMessage, 4, 60)
            ...
            G_msgBuses_subscribe("mera", N_n_3_32_rcvs_0)
        

            N_n_3_32_state.msgSpecs = [
...
N_n_3_32_state.msgSpecs[0].outTemplate = []

                N_n_3_32_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_32_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_32_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_32_state.msgSpecs[0].outMessage, 0, 69)
            

                G_msg_writeFloatToken(N_n_3_32_state.msgSpecs[0].outMessage, 1, 67)
            

                G_msg_writeFloatToken(N_n_3_32_state.msgSpecs[0].outMessage, 2, 64)
            

                G_msg_writeFloatToken(N_n_3_32_state.msgSpecs[0].outMessage, 3, 62)
            

                G_msg_writeFloatToken(N_n_3_32_state.msgSpecs[0].outMessage, 4, 60)
            
        

            G_msgBuses_subscribe("poan", N_n_3_33_rcvs_0)
        

            N_n_3_33_state.msgSpecs = [
...
N_n_3_33_state.msgSpecs[0].outTemplate = []

                N_n_3_33_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_33_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_33_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_33_state.msgSpecs[0].outMessage, 0, 68)
            

                G_msg_writeFloatToken(N_n_3_33_state.msgSpecs[0].outMessage, 1, 66)
            

                G_msg_writeFloatToken(N_n_3_33_state.msgSpecs[0].outMessage, 2, 64)
            

                G_msg_writeFloatToken(N_n_3_33_state.msgSpecs[0].outMessage, 3, 62)
            

                G_msg_writeFloatToken(N_n_3_33_state.msgSpecs[0].outMessage, 4, 60)
            
        

            G_msgBuses_subscribe("maisia", N_n_3_34_rcvs_0)
        

            N_n_3_34_state.msgSpecs = [
...
N_n_3_34_state.msgSpecs[0].outTemplate = []

                N_n_3_34_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_34_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_34_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_34_state.msgSpecs[0].outMessage, 0, 72)
            

                G_msg_writeFloatToken(N_n_3_34_state.msgSpecs[0].outMessage, 1, 68)
            

                G_msg_writeFloatToken(N_n_3_34_state.msgSpecs[0].outMessage, 2, 65)
            

                G_msg_writeFloatToken(N_n_3_34_state.msgSpecs[0].outMessage, 3, 62)
            

                G_msg_writeFloatToken(N_n_3_34_state.msgSpecs[0].outMessage, 4, 60)
            
        

            G_msgBuses_subscribe("bagat", N_n_3_35_rcvs_0)
        

            N_n_3_35_state.msgSpecs = [
...
N_n_3_35_state.msgSpecs[0].outTemplate = []

                N_n_3_35_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_35_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_35_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_35_state.msgSpecs[0].outMessage, 0, 72)
            

                G_msg_writeFloatToken(N_n_3_35_state.msgSpecs[0].outMessage, 1, 68)
            

                G_msg_writeFloatToken(N_n_3_35_state.msgSpecs[0].outMessage, 2, 66)
            

                G_msg_writeFloatToken(N_n_3_35_state.msgSpecs[0].outMessage, 3, 63)
            

                G_msg_writeFloatToken(N_n_3_35_state.msgSpecs[0].outMessage, 4, 60)
            
        

            G_msgBuses_subscribe("mazand", N_n_3_36_rcvs_0)
        

            N_n_3_36_state.msgSpecs = [
...
N_n_3_36_state.msgSpecs[0].outTemplate = []

                N_n_3_36_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_36_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_36_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_36_state.msgSpecs[0].outMessage, 0, 68)
            

                G_msg_writeFloatToken(N_n_3_36_state.msgSpecs[0].outMessage, 1, 67)
            

                G_msg_writeFloatToken(N_n_3_36_state.msgSpecs[0].outMessage, 2, 65)
            

                G_msg_writeFloatToken(N_n_3_36_state.msgSpecs[0].outMessage, 3, 62)
            

                G_msg_writeFloatToken(N_n_3_36_state.msgSpecs[0].outMessage, 4, 60)
            
        

            G_msgBuses_subscribe("rastad", N_n_3_37_rcvs_0)
        

            N_n_3_37_state.msgSpecs = [
...
N_n_3_37_state.msgSpecs[0].outTemplate = []

                N_n_3_37_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
...
N_n_3_37_state.msgSpecs[0].outMessage = G_msg_create(N_n_3_37_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_3_37_state.msgSpecs[0].outMessage, 0, 68)
            

                G_msg_writeFloatToken(N_n_3_37_state.msgSpecs[0].outMessage, 1, 67)
            

                G_msg_writeFloatToken(N_n_3_37_state.msgSpecs[0].outMessage, 2, 65)
            

                G_msg_writeFloatToken(N_n_3_37_state.msgSpecs[0].outMessage, 3, 63)
            

                G_msg_writeFloatToken(N_n_3_37_state.msgSpecs[0].outMessage, 4, 60)
            
        
G_commons_waitFrame(0, () => N_n_5_35_snds_0(G_bangUtils_bang()))

            N_n_5_65_state.msgSpecs = [
...
N_n_5_65_state.msgSpecs[0].outTemplate = []

                N_n_5_65_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_5_65_state.msgSpecs[0].outMessage = G_msg_create(N_n_5_65_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_5_65_state.msgSpecs[0].outMessage, 0, 93)
            
        


            NT_mul_setLeft(N_n_5_64_state, 0)
            NT_mul_setRight(N_n_5_64_state, 0.125)
        



            N_n_5_66_state.msgSpecs = [
...
N_n_5_66_state.msgSpecs[0].outTemplate = []

                N_n_5_66_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_5_66_state.msgSpecs[0].outMessage = G_msg_create(N_n_5_66_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_5_66_state.msgSpecs[0].outMessage, 0, 98)
            
        


            NT_div_setLeft(N_n_5_32_state, 0)
            NT_div_setRight(N_n_5_32_state, 200)
        



            N_n_5_67_state.msgSpecs = [
...
N_n_5_67_state.msgSpecs[0].outTemplate = []

                N_n_5_67_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_5_67_state.msgSpecs[0].outMessage = G_msg_create(N_n_5_67_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_5_67_state.msgSpecs[0].outMessage, 0, 3000)
            
        


            N_n_5_41_state.msgSpecs = [
...
N_n_5_41_state.msgSpecs[0].outTemplate = []

                N_n_5_41_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_5_41_state.msgSpecs[0].outMessage = G_msg_create(N_n_5_41_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_5_41_state.msgSpecs[0].outMessage, 0, 3000)
            
        

            NT_float_setValue(N_n_5_44_state, 0)
...
N_n_5_68_state.msgSpecs[0].outTemplate = []

                N_n_5_68_state.msgSpecs[0].outTemplate.push(G_msg_FLOAT_TOKEN)
            
N_n_5_68_state.msgSpecs[0].outMessage = G_msg_create(N_n_5_68_state.msgSpecs[0].outTemplate)

                G_msg_writeFloatToken(N_n_5_68_state.msgSpecs[0].outMessage, 0, 20)
            
        


            NT_float_setValue(N_n_5_45_state, 0)
        

            NT_mul_setLeft(N_n_5_46_state, 0)
            NT_mul_setRight(N_n_5_46_state, 0.01)
            ...
            NT_osc_t_setStep(N_n_7_2_state, 0)
        




            NT_osc_t_setStep(N_n_7_4_state, 0)
        




            NT_osc_t_setStep(N_n_8_2_state, 0)
        




            NT_osc_t_setStep(N_n_8_4_state, 0)
        ...
        N_n_6_14_state.setDelayNameCallback = function (_) {
            N_n_6_14_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_14_state.delayName)
            NT_delread_t_updateOffset(N_n_6_14_state)
        }

        if ("0-ref1".length) {
            NT_delread_t_setDelayName(N_n_6_14_state, "0-ref1", N_n_6_14_state.setDelayNameCallback)
        }
    



        N_n_6_16_state.setDelayNameCallback = function (_) {
            N_n_6_16_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_16_state.delayName)
            NT_delread_t_updateOffset(N_n_6_16_state)
        }

        if ("0-ref2".length) {
            NT_delread_t_setDelayName(N_n_6_16_state, "0-ref2", N_n_6_16_state.setDelayNameCallback)
        }
    



        N_n_6_18_state.setDelayNameCallback = function (_) {
            N_n_6_18_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_18_state.delayName)
            NT_delread_t_updateOffset(N_n_6_18_state)
        }

        if ("0-ref3".length) {
            NT_delread_t_setDelayName(N_n_6_18_state, "0-ref3", N_n_6_18_state.setDelayNameCallback)
        }
    



        N_n_6_20_state.setDelayNameCallback = function (_) {
            N_n_6_20_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_20_state.delayName)
            NT_delread_t_updateOffset(N_n_6_20_state)
        }

        if ("0-ref4".length) {
            NT_delread_t_setDelayName(N_n_6_20_state, "0-ref4", N_n_6_20_state.setDelayNameCallback)
        }
    



        N_n_6_24_state.setDelayNameCallback = function (_) {
            N_n_6_24_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_24_state.delayName)
            NT_delread_t_updateOffset(N_n_6_24_state)
        }

        if ("0-ref5".length) {
            NT_delread_t_setDelayName(N_n_6_24_state, "0-ref5", N_n_6_24_state.setDelayNameCallback)
        }
        ...
        if ("0-del1".length) {
            NT_delread_t_setDelayName(N_n_5_16_state, "0-del1", N_n_5_16_state.setDelayNameCallback)
        }
        ...
        N_n_6_22_state.setDelayNameCallback = function (_) {
            N_n_6_22_state.buffer = G_delayBuffers__BUFFERS.get(N_n_6_22_state.delayName)
            NT_delread_t_updateOffset(N_n_6_22_state)
        }

        if ("0-ref6".length) {
            NT_delread_t_setDelayName(N_n_6_22_state, "0-ref6", N_n_6_22_state.setDelayNameCallback)
        }
    


        N_n_5_17_state.setDelayNameCallback = function (_) {
            N_n_5_17_state.buffer = G_delayBuffers__BUFFERS.get(N_n_5_17_state.delayName)
            NT_delread_t_updateOffset(N_n_5_17_state)
        }

        if ("0-del2".length) {
            NT_delread_t_setDelayName(N_n_5_17_state, "0-del2", N_n_5_17_state.setDelayNameCallback)
        }
        ...
        if ("0-del3".length) {
            NT_delread_t_setDelayName(N_n_5_18_state, "0-del3", N_n_5_18_state.setDelayNameCallback)
        }
        ...
        N_n_5_19_state.setDelayNameCallback = function (_) {
            N_n_5_19_state.buffer = G_delayBuffers__BUFFERS.get(N_n_5_19_state.delayName)
            NT_delread_t_updateOffset(N_n_5_19_state)
        }

        if ("0-del4".length) {
            NT_delread_t_setDelayName(N_n_5_19_state, "0-del4", N_n_5_19_state.setDelayNameCallback)
        }
        ...
        N_n_5_22_state.buffer = G_buf_create(
        ...
        if ("0-del1".length) {
            NT_delwrite_t_setDelayName(N_n_5_22_state, "0-del1")
        }
        ...
        if ("0-del2".length) {
            NT_delwrite_t_setDelayName(N_n_5_23_state, "0-del2")
        }
    


        N_n_5_24_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                74.5234,
                "msec"
        ...
        if ("0-del3".length) {
            NT_delwrite_t_setDelayName(N_n_5_24_state, "0-del3")
        }
    


        N_n_5_25_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                86.1244,
                "msec"
        ...
        if ("0-del4".length) {
            NT_delwrite_t_setDelayName(N_n_5_25_state, "0-del4")
        }
    

        N_n_6_13_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                43.5337,
                "msec"
        ...
        if ("0-ref1".length) {
            NT_delwrite_t_setDelayName(N_n_6_13_state, "0-ref1")
        }
    


        N_n_6_15_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                25.796,
                "msec"
        ...
        if ("0-ref2".length) {
            NT_delwrite_t_setDelayName(N_n_6_15_state, "0-ref2")
        }
    


        N_n_6_17_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                19.392,
                "msec"
        ...
        if ("0-ref3".length) {
            NT_delwrite_t_setDelayName(N_n_6_17_state, "0-ref3")
        }
    


        N_n_6_19_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                16.364,
                "msec"
        ...
        if ("0-ref4".length) {
            NT_delwrite_t_setDelayName(N_n_6_19_state, "0-ref4")
        }
    


        N_n_6_21_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                4.2546,
                "msec"
        ...
        if ("0-ref6".length) {
            NT_delwrite_t_setDelayName(N_n_6_21_state, "0-ref6")
        }
    


        N_n_6_23_state.buffer = G_buf_create(
            toInt(Math.ceil(computeUnitInSamples(
                SAMPLE_RATE, 
                7.645,
                "msec"
        ...
        if ("0-ref5".length) {
            NT_delwrite_t_setDelayName(N_n_6_23_state, "0-ref5")
        }
...
NT_osc_t_setStep(N_n_4_4_state, ((N_m_n_4_1_0_sig_state.currentValue) + (N_n_4_2_outs_0 * (N_m_n_4_15_1_sig_state.currentValue))))
...
N_n_4_7_outs_0 = N_n_4_5_outs_0 * N_n_4_5_outs_0
                ...
                N_n_7_2_outs_0 = Math.cos(N_n_7_2_state.phase)
                N_n_7_2_state.phase += N_n_7_2_state.step
            
NT_osc_t_setStep(N_n_7_4_state, ((N_m_n_7_1_0_sig_state.currentValue) + (N_n_7_2_outs_0 * (N_m_n_7_15_1_sig_state.currentValue))))

                N_n_7_4_outs_0 = Math.cos(N_n_7_4_state.phase)
                N_n_7_4_state.phase += N_n_7_4_state.step
...
N_n_7_7_outs_0 = N_n_7_5_outs_0 * N_n_7_5_outs_0

                N_n_8_2_outs_0 = Math.cos(N_n_8_2_state.phase)
                N_n_8_2_state.phase += N_n_8_2_state.step
            
NT_osc_t_setStep(N_n_8_4_state, ((N_m_n_8_1_0_sig_state.currentValue) + (N_n_8_2_outs_0 * (N_m_n_8_14_1_sig_state.currentValue))))

                N_n_8_4_outs_0 = Math.cos(N_n_8_4_state.phase)
                N_n_8_4_state.phase += N_n_8_4_state.step
            

        N_n_8_5_outs_0 = N_n_8_5_state.currentValue
        if (toFloat(FRAME) < N_n_8_5_state.currentLine.p1.x) {
            N_n_8_5_state.currentValue += N_n_8_5_state.currentLine.dy
            if (toFloat(FRAME + 1) >= N_n_8_5_state.currentLine.p1.x) {
                N_n_8_5_state.currentValue = N_n_8_5_state.currentLine.p1.y
            }
        }
    
N_n_8_7_outs_0 = N_n_8_5_outs_0 * N_n_8_5_outs_0
N_n_0_33_outs_0 = ((N_n_4_4_outs_0 * (N_n_4_7_outs_0 * N_n_4_7_outs_0)) + ((N_n_7_4_outs_0 * (N_n_7_7_outs_0 * N_n_7_7_outs_0)) + (N_n_8_4_outs_0 * (N_n_8_7_outs_0 * N_n_8_7_outs_0)))) * (N_m_n_0_33_1_sig_state.currentValue)
N_n_6_14_outs_0 = G_buf_readSample(N_n_6_14_state.buffer, N_n_6_14_state.offset)
N_n_6_1_outs_0 = N_n_0_33_outs_0 + N_n_6_14_outs_0
N_n_6_16_outs_0 = G_buf_readSample(N_n_6_16_state.buffer, N_n_6_16_state.offset)
N_n_6_2_outs_0 = N_n_6_1_outs_0 + N_n_6_16_outs_0
N_n_6_18_outs_0 = G_buf_readSample(N_n_6_18_state.buffer, N_n_6_18_state.offset)
N_n_6_5_outs_0 = N_n_6_2_outs_0 + N_n_6_18_outs_0
N_n_6_20_outs_0 = G_buf_readSample(N_n_6_20_state.buffer, N_n_6_20_state.offset)
N_n_6_7_outs_0 = N_n_6_5_outs_0 + N_n_6_20_outs_0
N_n_6_24_outs_0 = G_buf_readSample(N_n_6_24_state.buffer, N_n_6_24_state.offset)
N_n_5_16_outs_0 = G_buf_readSample(N_n_5_16_state.buffer, N_n_5_16_state.offset)
N_n_5_34_state.previous = N_n_5_34_outs_0 = N_n_5_34_state.coeff * N_n_5_16_outs_0 + (1 - N_n_5_34_state.coeff) * N_n_5_34_state.previous

        N_n_5_48_outs_0 = N_n_5_48_state.currentValue
        if (toFloat(FRAME) < N_n_5_48_state.currentLine.p1.x) {
            N_n_5_48_state.currentValue += N_n_5_48_state.currentLine.dy
            if (toFloat(FRAME + 1) >= N_n_5_48_state.currentLine.p1.x) {
                N_n_5_48_state.currentValue = N_n_5_48_state.currentLine.p1.y
            }
        }
    

        N_n_5_15_outs_0 = N_n_5_15_state.currentValue
        if (toFloat(FRAME) < N_n_5_15_state.currentLine.p1.x) {
            N_n_5_15_state.currentValue += N_n_5_15_state.currentLine.dy
            if (toFloat(FRAME + 1) >= N_n_5_15_state.currentLine.p1.x) {
                N_n_5_15_state.currentValue = N_n_5_15_state.currentLine.p1.y
            }
        }
    
N_n_5_9_outs_0 = (N_n_6_7_outs_0 + N_n_6_24_outs_0) + ((N_n_5_16_outs_0 + ((N_n_5_34_outs_0 - N_n_5_16_outs_0) * N_n_5_48_outs_0)) * N_n_5_15_outs_0)

        N_n_5_14_outs_0 = N_n_5_14_state.currentValue
        if (toFloat(FRAME) < N_n_5_14_state.currentLine.p1.x) {
            N_n_5_14_state.currentValue += N_n_5_14_state.currentLine.dy
            if (toFloat(FRAME + 1) >= N_n_5_14_state.currentLine.p1.x) {
                N_n_5_14_state.currentValue = N_n_5_14_state.currentLine.p1.y
            }
        }
    
N_n_6_22_outs_0 = G_buf_readSample(N_n_6_22_state.buffer, N_n_6_22_state.offset)
N_n_5_17_outs_0 = G_buf_readSample(N_n_5_17_state.buffer, N_n_5_17_state.offset)
N_n_5_52_state.previous = N_n_5_52_outs_0 = N_n_5_52_state.coeff * N_n_5_17_outs_0 + (1 - N_n_5_52_state.coeff) * N_n_5_52_state.previous
N_n_5_10_outs_0 = N_n_6_22_outs_0 + ((N_n_5_17_outs_0 + ((N_n_5_52_outs_0 - N_n_5_17_outs_0) * N_n_5_48_outs_0)) * N_n_5_15_outs_0)
OUTPUT[0][IT_FRAME] = (N_n_0_33_outs_0 + (N_n_5_9_outs_0 * N_n_5_14_outs_0))
OUTPUT[1][IT_FRAME] = (N_n_0_33_outs_0 + (N_n_5_10_outs_0 * N_n_5_14_outs_0))
N_n_5_0_outs_0 = N_n_5_9_outs_0 + N_n_5_10_outs_0
N_n_5_18_outs_0 = G_buf_readSample(N_n_5_18_state.buffer, N_n_5_18_state.offset)
N_n_5_56_state.previous = N_n_5_56_outs_0 = N_n_5_56_state.coeff * N_n_5_18_outs_0 + (1 - N_n_5_56_state.coeff) * N_n_5_56_state.previous
N_n_5_4_outs_0 = (N_n_5_18_outs_0 + ((N_n_5_56_outs_0 - N_n_5_18_outs_0) * N_n_5_48_outs_0)) * N_n_5_15_outs_0
N_n_5_19_outs_0 = G_buf_readSample(N_n_5_19_state.buffer, N_n_5_19_state.offset)
N_n_5_60_state.previous = N_n_5_60_outs_0 = N_n_5_60_state.coeff * N_n_5_19_outs_0 + (1 - N_n_5_60_state.coeff) * N_n_5_60_state.previous
N_n_5_2_outs_0 = (N_n_5_19_outs_0 + ((N_n_5_60_outs_0 - N_n_5_19_outs_0) * N_n_5_48_outs_0)) * N_n_5_15_outs_0
N_n_5_12_outs_0 = N_n_5_4_outs_0 + N_n_5_2_outs_0
G_buf_writeSample(N_n_5_22_state.buffer, (N_n_5_0_outs_0 + N_n_5_12_outs_0))
N_n_5_13_outs_0 = N_n_5_9_outs_0 - N_n_5_10_outs_0
N_n_5_11_outs_0 = N_n_5_4_outs_0 - N_n_5_2_outs_0
G_buf_writeSample(N_n_5_23_state.buffer, (N_n_5_13_outs_0 + N_n_5_11_outs_0))
G_buf_writeSample(N_n_5_24_state.buffer, (N_n_5_0_outs_0 - N_n_5_12_outs_0))
G_buf_writeSample(N_n_5_25_state.buffer, (N_n_5_13_outs_0 - N_n_5_11_outs_0))
G_buf_writeSample(N_n_6_13_state.buffer, N_n_0_33_outs_0)
G_buf_writeSample(N_n_6_15_state.buffer, (N_n_0_33_outs_0 - N_n_6_14_outs_0))
G_buf_writeSample(N_n_6_17_state.buffer, (N_n_6_1_outs_0 - N_n_6_16_outs_0))
G_buf_writeSample(N_n_6_19_state.buffer, (N_n_6_2_outs_0 - N_n_6_18_outs_0))
G_buf_writeSample(N_n_6_21_state.buffer, (N_n_6_7_outs_0 - N_n_6_24_outs_0))
G_buf_writeSample(N_n_6_23_state.buffer, (N_n_6_5_outs_0 - N_n_6_20_outs_0))
            FRAME++
        }
